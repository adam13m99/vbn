...
OUTPUT_FILE = "tf_menu_labeled_v5.csv"
...
CONFIG: Dict[str, Any] = {
    ...
    "BATCH_SIZE": 5,   # minimal batch - testing if taxonomy size is the issue
            ...
            try:
                ...
                with self.model_lock:
                    try:
                        ...
                        logging.info(f"Timeout not supported, calling without timeout...")
