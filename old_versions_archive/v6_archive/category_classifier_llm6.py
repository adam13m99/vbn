"""
Product Category CLASSIFIER V6 - Enhanced monitoring and notifications
...
- Output: tf_menu_labeled_v6.csv (Appends results incrementally)
...
- All V5 features: system_instruction, detailed logging, optimal settings
...
OUTPUT_FILE = "tf_menu_labeled_v7.csv"
...
CONFIG: Dict[str, Any] = {
    ...
    "RATE_LIMIT_PER_SEC": 0.15,  # = 9 req/min (safely under 10 RPM limit)
    ...
    # --- V6: Rate Watchdog ---
    "MIN_ITEMS_PER_MINUTE": 2,  # Stop if processing slower than this (expect ~225/min at 9 RPM)
...
def main():
    ...
    telegram.send(
        f"[tf_menu] Started V6 - Enhanced Monitoring.\n"
