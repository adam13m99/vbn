...
CONFIG: Dict[str, Any] = {
    # --- Gemini ---
    "GEMINI_API_KEY": os.getenv("GENAI_API_KEY", "AIzaSyBBtEmdCxZn2Xlj3e-ydi-AR46C9Gi3bDw"),
    ...
    # --- V8: Rate Watchdog ---
    "MIN_ITEMS_PER_MINUTE": 150,  # Stop if processing slower than this (expect ~225/min at 9 RPM)
